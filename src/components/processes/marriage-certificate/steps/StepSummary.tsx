    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <SummaryCard title="Epoux(se) 1">
          ...
          {formData.nomUsage && (
            <p className="text-sm text-gray-500">Usage : {formData.nomUsage}</p>
          )}
          <p className="text-sm text-gray-500">
        ...
        <SummaryCard title="Epoux(se) 2">
          ...
          {formData.spouseNomUsage && (
            <p className="text-sm text-gray-500">Usage : {formData.spouseNomUsage}</p>
          )}
          <p className="text-sm text-gray-500">
            Ne(e) le {formatDate(formData.spouseBirthDate)}
          </p>
        </SummaryCard>
