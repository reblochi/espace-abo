...
export function StepDelivery() {
  const { register, formState: { errors } } = useFormContext<MarriageCertificateInput>();
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-gray-500 mb-2">
        Adresse a laquelle vous souhaitez recevoir votre acte de mariage.
      </p>
